...
```shell-session
LeDaav@htb[/htb]$ cat /etc/exports 
...
```shell-session
LeDaav@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
LeDaav@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
LeDaav@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
LeDaav@htb[/htb]$ mkdir target-NFS
LeDaav@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
LeDaav@htb[/htb]$ cd target-NFS
LeDaav@htb[/htb]$ tree .
...
```shell-session
LeDaav@htb[/htb]$ cd ..
LeDaav@htb[/htb]$ sudo umount ./target-NFS
```