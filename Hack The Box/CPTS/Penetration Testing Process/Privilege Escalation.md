...
```shell-session
LeDaav@htb[/htb]$ sudo -u user /bin/echo Hello World!
...
```shell-session
LeDaav@htb[/htb]$ vim id_rsa
LeDaav@htb[/htb]$ chmod 600 id_rsa
LeDaav@htb[/htb]$ ssh root@10.10.10.10 -i id_rsa
...
```shell-session
LeDaav@htb[/htb]$ ssh-keygen -f key
...
```shell-session
LeDaav@htb[/htb]$ ssh root@10.10.10.10 -i key
