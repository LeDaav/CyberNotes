...
```shell-session
LeDaav@htb[/htb]$ sudo mkdir /etc/systemd/system/mytimer.timer.d
LeDaav@htb[/htb]$ sudo vim /etc/systemd/system/mytimer.timer
```
...
```shell-session
LeDaav@htb[/htb]$ sudo vim /etc/systemd/system/mytimer.service
```
...
```shell-session
LeDaav@htb[/htb]$ sudo systemctl daemon-reload
```
...
```shell-session
LeDaav@htb[/htb]$ sudo systemctl start mytimer.timer
LeDaav@htb[/htb]$ sudo systemctl enable mytimer.timer
```
