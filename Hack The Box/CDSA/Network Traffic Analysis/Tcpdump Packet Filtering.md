...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 host 172.16.146.2
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 src host 172.16.146.2
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 udp
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 proto 17
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 tcp port 443
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 portrange 0-1024
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 less 64
...
LeDaav@htb[/htb]$ sudo tcpdump -i eth0 host 192.168.0.1 and port 23
...
LeDaav@htb[/htb]$ sudo tcpdump -r sus.pcap icmp or host 172.16.146.1
...
LeDaav@htb[/htb]$ sudo tcpdump -r sus.pcap not icmp
