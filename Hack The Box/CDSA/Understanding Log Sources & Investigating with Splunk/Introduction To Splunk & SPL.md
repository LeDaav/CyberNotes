...
12. **The lookup command**
    ...
    ![Splunk interface for adding a new lookup table file. Destination app is 'search', uploading 'malware\_lookup.csv', with the destination filename 'malware\_lookup.csv'.](https://academy.hackthebox.com/storage/modules/218/110.png)
