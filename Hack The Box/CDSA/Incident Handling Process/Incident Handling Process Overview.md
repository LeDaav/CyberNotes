...
As defined by NIST, the incident handling process consists of the following four (4) distinct stages: ![Incident response process flowchart: Preparation, Detection & Analysis, Containment Eradication & Recovery, Post-Incident Activity.](https://academy.hackthebox.com/storage/modules/148/handling_process.png)
