...
![PowerShell window running Rubeus.exe for Kerberoasting. Version 1.6.1 identifies one Kerberoastable user: "iis\_svc" with service principal name "HTTP/iis.lab.internal.local." Displays hash and account details.](https://academy.hackthebox.com/storage/modules/233/image76.png)
...
![Splunk search results for EventCodes 4648 and 4769. Two events on 2023-07-26 at 16:23:15. User "TAYLOR\_BENTON" attempted logon with explicit credentials and requested a Kerberos service ticket. Source IP: 10.10.0.101, service name: iis\_svc.](https://academy.hackthebox.com/storage/modules/233/7.png)
...
![Splunk search results for EventCodes 4648 and 4769 with service name iis\_svc. One event on 2023-07-27 at 09:34:00. Username: JOLENE\_MCGEE. Event: 4769. Service name: iis\_svc.](https://academy.hackthebox.com/storage/modules/233/9.png)
...
![Splunk search results for EventCodes 4648 and 4769 with service name iis\_svc. One event on 2023-07-27 at 09:34:28. Username: JOLENE\_MCGEE. EventCode: 4769. Service name: iis\_svc.](https://academy.hackthebox.com/storage/modules/233/10.png)
...
![PowerShell window running Rubeus.exe for AS-REP roasting. Version 1.6.1 targets domain "lab.internal.local." User: KEN\_MORTON. AS-REP without preauth is successful. Displays AS-REP hash.](https://academy.hackthebox.com/storage/modules/233/image40.png)
...
![Network packet capture showing Kerberos AS-REQ from 10.0.10.101 to 10.0.10.20. Includes PA-DATA items: PA-ENC-TIMESTAMP and PA-PAC-REQUEST. CName: JENNY\_HICKMAN, realm: LAB.INTERNAL.LOCAL.](https://academy.hackthebox.com/storage/modules/233/image79.png)
...
![Network packet capture showing Kerberos AS-REQ from 10.0.10.101 to 10.0.10.20. Includes PA-DATA item: PA-PAC-REQUEST. CName: JENNY\_HICKMAN, realm: LAB.INTERNAL.LOCAL.](https://academy.hackthebox.com/storage/modules/233/image78.png)
